...
<body class="font-body">
    <div class="flex">
        <side class="w-64 h-14 bg-red-500" style="background-color: red;">hello world</side>
        <div class="w-svw">
            <!-- Header -->
            ...
            <div class="flex w-full">
                <!-- messages side bar -->
                <div class="side-container fixed h-screen overflow-hidden" style="width: 360px;">
                ...
                <main style="width: calc(100% - 360px); margin-left: 360px;">
                    <div class="pt-4 pb-3">
