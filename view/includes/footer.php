<footer class="bg-gradient-to-r from-gray-100 via-[#ffe8d0] to-gray-100">
  <div class="max-w-screen-xl px-5 py-10 mx-auto sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            ...
            <a class="hover:opacity-75" href> Logistic </a>
        ...
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a class="hover:opacity-75" href> Help/FAQ </a>
            <a class="hover:opacity-75" href> Press </a>
            <a class="hover:opacity-75" href> Affilates </a>
          </nav>
        </div>
        <div>
          <p class="font-medium">
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            <a class="hover:opacity-75" href> Press Centre </a>
            <a class="hover:opacity-75" href> Our Blog </a>
            <a class="hover:opacity-75" href> Low fare tips </a>
    ...
    <div class="mt-6 ...">
      ...
      Copyright,IMMOCONNECT 2023. All rights reserved.
      </p>
      <p class="mt-8 text-xs text-gray-600">
      Terms & Conditions
      </p>
