...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white rounded-lg overflow-hidden shadow-md">
        ...
        <!-- Seller and Address -->
        <div class="p-7">
            <p class="text-sm text-gray-600">Seller: John Doe || 123 Main St, City</p>
        </div>
        ...
        <!-- Explore and Message Buttons -->
        <div class="flex justify-between p-4">
            <button class="bg-blue-500 text-white px-4 py-2 rounded-full">Explore Details</button>
